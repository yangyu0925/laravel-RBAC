                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-hover" id="treeTable">
                            ...
                            <tr id="{{ $menu['id'] }}" pId="{{ $menu['parent_id'] }}">
                                ...
                                <td>
                                    <a href="{{route('menus.edit', $menu['id'])}}"><button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil"> 编辑</i></button></a>
                                    <a href="javascript:;" data-id="{{$menu['id']}}" class="btn btn-danger btn-xs destroy">
                                        <i class="fa fa-trash"> 删除</i>
                                        <form action="{{route('menus.destroy', $menu['id'])}}" method="POST" name="delete_item_{{$menu['id']}}" style="display:none">
                                            {{method_field('DELETE')}}
                                            {{csrf_field()}}
                                        </form>
                                    </a>
